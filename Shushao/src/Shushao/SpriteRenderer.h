...
public:
    ...
    Color color = { 1.0f, 1.0f, 1.0f,
                   1.0f }; //	Rendering color for the Sprite graphic.
    bool flipX;           //	Flips the sprite on the X axis.
    bool flipY;           //	Flips the sprite on the Y axis.
    glm::vec2 size;       //	Property to set/get the size to render when the
                    //SpriteRenderer.drawMode is set to SpriteDrawMode.NineSlice.
